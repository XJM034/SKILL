...
| [`claude-agents-bootstrap`](skills/automation/claude-agents-bootstrap/SKILL.md) | Create lean evidence-first CLAUDE.md and AGENTS.md instruction docs |
...
| [`sync-feishu-code-collab`](skills/automation/sync-feishu-code-collab/SKILL.md) | Sync frontend-led code collaboration records into Feishu Base safely |
